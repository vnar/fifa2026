...
-- Open read/write for anonymous API users (security = unguessable room id in URL).
-- Anyone who can guess another room id could overwrite it; use long random ids (default in app).
